...
groups: {
           ...
           "escuelas" : {title: "Escuelas", expanded:false},
           "mapaescolar" : {title: "Unidades Educativas", expanded:false},
        /***************************
           "mapaescolar" : {title: "Unidades Educativas", expanded:false, isOnlyFolder: true, expanded: false,
                            groups: {
                                      "Estatal_Comun_Inicial": {title: "Nivel Inicial", expanded:false},
                                      "Estatal_Comun_Primario": {title: "Nivel Primario", expanded:false},
                                      "Estatal_Comun_Secundario": {title: "Nivel Secundario", expanded:false},
                                      "Estatal_Comun_Superior": {title: "Nivel Superior", expanded:false},
                                      
                                    }
                        },
        *///////////////////////////////////   
            "ambito" : {title: "Ámbito Geográfico", expanded:false},         
            "otros_org" : {title: "Organismos de Educación Descentralizados", expanded:false},
            "limite_partidos" : {title: "Límite de Partido", expanded:false},
            "limite_regiones" : {title: "Límite de Región", expanded:false},
            "predios" : {title: "Predios", expanded:false},
            /*            
            "jefaturas" : {title: "Jefaturas", expanded:false, isOnlyFolder: true, expanded: false,
                                 groups: {
                                      "jefaturas": {title: "Jefaturas", expanded:false},
...
/******************************
groups: {
"background" : {title: "Mapas Base", exclusive: true, expanded: true},
"default" : {title: "Camadas do Usuário", expanded:false},
"politico_administrativo" : {title: "Político-Administrativo", expanded:true},
"meio_fisico" : {title: "Meio Físico", expanded:false},
"logistica" : {title: "Logística", expanded:false, isOnlyFolder: true, expanded: false,

groups: {
"teste1": {title: "Teste 1", expanded:false},
"teste2": {title: "Teste 2", expanded:false},
"teste3": {title: "Teste 3", expanded:false, isOnlyFolder: true,

groups: {
"subteste1": {title: "Teste 1", expanded:false},
"subteste2": {title: "Teste 2", expanded:false},
"subteste3": {title: "Teste 3", expanded:false}
}

},
"teste4": {title: "Teste 4", expanded:false},
}
